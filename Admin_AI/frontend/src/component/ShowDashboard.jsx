...
export default function Users() {
  ...
  const fetchData = (csName, semester, academicYear) => {
    axios
      .get(import.meta.env.VITE_API + "/StartTimeDashboard", {
        params: {
          csName: csName,
          semester: semester,
      ...
      .catch((error) =>
        console.error("Error fetching Start Class data:", error)
      );

    axios
      .get(import.meta.env.VITE_API + "/FinishTimeDashboard", {
        params: {
          csName: csName,
          semester: semester,
          academicYear: academicYear,
      ...
      .catch((error) =>
        console.error("Error fetching Finish Class data:", error)
      );
  };
